<template>
    <div class="panel panel-default">
        ...
        <div class="panel">
            <div class="filter" v-if="showFilter" style="padding-left: 630px; margin-top: 10px;">
                <div class="filter-column">
                    <select class="select select-dropdown" v-model="params.search_column">
                        <option v-for="column in filter" :value="column">{{ column }}</option>
                    </select>
                </div>
                <div class="filter-operator">
                    <select class="select select-dropdown" v-model="params.search_operator">
                        <option v-for="(value, key) in operators" :value="key">{{ value }}</option>
                    </select>
                </div>
                <div class="filter-input">
                    <input type="text" class="input" v-model="params.search_query_1"
                ...
                <div class="filter-btn">
                    <a class="button is-info" @click="fetchData">
        ...
        <div class="panel-footer pagination-footer">
            <div class="pagination-item">
                <span>Per page: </span>
                <select class="select-dropdown" v-model="params.per_page" @change="fetchData">
                    <option>10</option>
                    <option>25</option>
                    <option>50</option>
                </select>
